...
_NOT_OBSERVABLE = {
    ...
    # 예시 저장소·검색 index 구성 오류. pipeline을 만들 때 나며 질문 관측에서는 나오지 않는다
    # (질문마다 나는 검색 실패는 RETRIEVAL_FAILED로 올라온다).
    "EXAMPLE_FIELD_MISSING", "EXAMPLE_FIELD_INVALID", "EXAMPLE_SPLIT_INVALID",
    "EXAMPLE_DUPLICATE_ID", "EXAMPLE_STORE_EMPTY", "RETRIEVAL_INDEX_MISSING",
    "RETRIEVAL_INDEX_INVALID", "RETRIEVAL_INDEX_STALE", "RETRIEVAL_EMBEDDER_MISMATCH",
    "RETRIEVAL_EMBEDDER_UNAVAILABLE", "RETRIEVAL_VECTOR_MISMATCH",
}
